...
import  uparo from "../images/Upword.svg";
import  downaro from "../images/Downword.svg";
            ...
            <div className='Timer'>
                ...
                <div className='Hours'>
                    <p className='hrs' >Hours</p>
                     <img src={uparo} onClick={increaseHours} /> 
                ...
                <div className='Minutes'>
                    <p>Minutes</p>
                    <img src={uparo} onClick={increaseMinutes} /> 
                    <h2>{formatValue(minutes)}</h2>
                    <img src={downaro} onClick={decreaseMinutes} /> 
                </div>
                <h1>:</h1>
                <div className='Seconds'>
                    <p>Seconds</p>
                    <img src={uparo} onClick={increaseSeconds} /> 
                    <h2>{formatValue(seconds)}</h2>
                     <img src={downaro} onClick={decreaseSeconds} /> 
                </div>
            </div>
